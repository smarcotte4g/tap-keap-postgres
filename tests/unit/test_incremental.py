...
import singer
from tap_keap_postgres.sync_strategies import incremental
...
class TestIncremental(TestCase):
    ...
    @patch("tap_keap_postgres.sync_strategies.incremental.post_db.hstore_available")
    @patch("psycopg2.extras.register_hstore")
    ...
    @patch("tap_keap_postgres.sync_strategies.incremental.singer.write_message")
    @patch("psycopg2.extras.register_hstore")
